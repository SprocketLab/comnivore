...
def get_cb(cb_dict, val_avg, val_wg):
    for cb in cb_dict:
        dict_ = cb_dict[cb]
        b_val_avg, b_val_wg, o_val_avg, o_val_wg = list(dict_.values())
        if (val_avg == b_val_avg and val_wg == b_val_wg) or (val_avg == o_val_avg and val_wg == o_val_wg):
            return cb
...
def scan_file(lines):
    ...
    return baseline_val_avg, baseline_val_wg, baseline_test_avg, baseline_test_wg, \
            ...
            baseline_cb,  ours_cb, params_str
...
def get_best_perf(val_list, test_list):
    ...
    best_val_perf, best_test_perf, best_val_idx
...
if __name__ == '__main__':
    ...
    for file_ in log_files:
        ...
        b_cb, o_cb, param_str_ = scan_file(lines)
